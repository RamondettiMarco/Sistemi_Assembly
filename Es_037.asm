...
;Dare in input un numero N senza echo; eseguire la ricerca del numero N, dando indicazioni
;(il numero inserito è più piccolo o più grande di N?) e contando i tentativi.
...
data segment
    ...
    str05 db "numero troppo PICCOLO$"
    str06 db "numero troppo GRANDE$"
    acapo db 10,13, "$"
    giusto db ?
    prova db ?
    conta db 1
...
; set segment registers:
    ...
    ;chiedo in input il numero senza usare la echo
    mov ah, 07
    int 21h
    mov giusto, al
